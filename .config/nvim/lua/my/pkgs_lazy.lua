...
require("lazy").setup {
  ...
  { "tpope/vim-rhubarb", dependencies = "tpope/vim-fugitive", cmd = { "G" } },
  "tpope/vim-eunuch",
  ...
  {
    config = ev "require[[my.plugins/splitjoin]]",
    keys = { "gS", "gJ" },
    "AndrewRadev/splitjoin.vim",
  },
  {
    config = ev "require[[my.plugins/gitsigns]]",
    event = "VimEnter",
    dependencies = { "nvim-lua/plenary.nvim" },
    "lewis6991/gitsigns.nvim",
  },
  {
    config = ev "require[[my.plugins/nvim-lspconfig]]",
  ...
  {
    config = ev "require[[my.plugins/LuaSnip]]",
