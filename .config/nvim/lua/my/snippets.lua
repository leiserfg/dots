...
ls.add_snippets(nil,
    { direnv = { s({ wordTrig = true, trig = "lay" }, { t({ "layout " }), i(1, { "python" }), i(0, {}) }) },
        all = {
            sf("date", date),
            sf("uuid", uuid_),
            sf("lorem(%d*)", lorem, true),
            s({ trig = "bbox" },
                { t({ "\226\149\148" }), f(replace_each("\226\149\144"), { 1 }), t({ "\226\149\151", "\226\149\145" }),
                    i(1, { "content" }), t({ "\226\149\145", "\226\149\154" }), f(replace_each("\226\149\144"), { 1 }),
                    t({ "\226\149\157" }), i(0, "asd") }),
        } })
