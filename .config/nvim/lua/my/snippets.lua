...
-- local fmt = require'luasnip.extras.fmt'.fmt
-- local dollar = vim.pesc'$'
--
-- local function _text_to_fmt(text)
--     local parts = {}
--     for text:gfind(dollar)
--
-- end
--
-- local function _text_to_snipp(txt)
--     local format, identifiers = _text_to_fmt(txt)
--     local inputs = {}
--     for name, _ in ipairs(identifiers) do
--         inputs[name] = ls.i
--     end
--     return fmt(format, inputs)
--
-- end
--
--
...
-- local last_snip = nil
--
-- local function expand_register_snip()
--   local reg = vim.f.get_reg()
--   if last_reg ~= reg then
--       last_snip = _text_to_snipp(reg)
--   end
--   return last_snip
-- end
