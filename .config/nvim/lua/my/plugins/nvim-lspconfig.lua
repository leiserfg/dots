local function on_attach()
  ...
  mappings = {gd = lb.definition, K = lb.hover, gD = lb.implementation, ["<c-k>"] = lb.signature_help, ["1gD"] = lb.type_definition, g0 = lb.document_symbol, gW = lb.workspace_symbol, ["<Leader>="] = format, ["<Leader>a"] = lb.code_action, ["<Leader>q"] = ld.setloclist, ["[d"] = ld.goto_prev, ["]d"] = ld.goto_next}
...
lspconfig.pylsp.setup({on_attach = on_attach, on_init = init, capabilities = capabilities})
