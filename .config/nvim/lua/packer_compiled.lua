...
local no_errors, error_msg = pcall(function()
  ...
  local package_path_str =
    "/home/leiserfg/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?.lua;/home/leiserfg/.cache/nvim/packer_hererocks/2.1.0-beta3/share/lua/5.1/?/init.lua;/home/leiserfg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?.lua;/home/leiserfg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/luarocks/rocks-5.1/?/init.lua"
  local install_cpath_pattern =
    "/home/leiserfg/.cache/nvim/packer_hererocks/2.1.0-beta3/lib/lua/5.1/?.so"
  ...
  _G.packer_plugins = {
    ...
    ["filetype.nvim"] = {
      config = { 'require"filetype".setup{literal = {[".envrc"] = "direnv"}}' },
      loaded = true,
    ...
    ["nvim-comment"] = {
      ...
      loaded = false,
      needs_bufread = false,
      path = "/home/leiserfg/.local/share/nvim/site/pack/packer/opt/nvim-comment",
    },
    ["nvim-fzf"] = {
      loaded = true,
    ...
    ["vim-fugitive"] = {
      after = { "vim-rhubarb" },
      commands = { "G" },
      config = { "require('my.plugins/vim-fugitive')" },
      loaded = false,
      needs_bufread = true,
    ...
    ["vim-polyglot"] = {
      loaded = false,
      needs_bufread = true,
      path = "/home/leiserfg/.local/share/nvim/site/pack/packer/opt/vim-polyglot",
    },
    ["vim-repeat"] = {
      loaded = true,
  ...
  require("filetype").setup { literal = { [".envrc"] = "direnv" } }
  ...
  pcall(
    vim.cmd,
    [[command -nargs=* -range -bang -complete=file EnMasse lua require("packer.load")({'vim-enmasse'}, { cmd = "EnMasse", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
  )
  pcall(
    vim.cmd,
    [[command -nargs=* -range -bang -complete=file Codi lua require("packer.load")({'codi.vim'}, { cmd = "Codi", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
  )
  pcall(
    vim.cmd,
    [[command -nargs=* -range -bang -complete=file Z lua require("packer.load")({'zoxide.vim'}, { cmd = "Z", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
  )
  pcall(
    vim.cmd,
  ...
  pcall(
    vim.cmd,
    [[command -nargs=* -range -bang -complete=file G lua require("packer.load")({'vim-fugitive'}, { cmd = "G", l1 = <line1>, l2 = <line2>, bang = <q-bang>, args = <q-args>, mods = "<mods>" }, _G.packer_plugins)]]
  )
  ...
  vim.cmd [[au BufRead * ++once lua require("packer.load")({'vim-unimpaired', 'vim-fugitive', 'gitsigns.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
  time([[Defining lazy-load event autocommands]], false)
  vim.cmd "augroup END"
  vim.cmd [[augroup filetypedetect]]
  time(
    [[Sourcing ftdetect script at: /home/leiserfg/.local/share/nvim/site/pack/packer/opt/orgmode.nvim/ftdetect/org.vim]],
    true
  )
  ...
  time(
    [[Sourcing ftdetect script at: /home/leiserfg/.local/share/nvim/site/pack/packer/opt/orgmode.nvim/ftdetect/org_archive.vim]],
    true
  )
  ...
  time(
    [[Sourcing ftdetect script at: /home/leiserfg/.local/share/nvim/site/pack/packer/opt/aniseed/ftdetect/fennel.vim]],
    true
  )
