...
_G.packer_plugins = {
  ...
  ["lightline.vim"] = {
    loaded = true,
    path = "/home/leiserfg/.local/share/nvim/site/pack/packer/start/lightline.vim"
  },
  ["notational-fzf-vim"] = {
    loaded = true,
  ...
  ["vim-signify"] = {
    loaded = true,
    path = "/home/leiserfg/.local/share/nvim/site/pack/packer/start/vim-signify"
  },
  ["vim-snippets"] = {
