function release_diff
  ...
  git tag --sort=-creatordate|head -n 2|tac|xargs -n2 sh -c 'git diff --binary $1 $2 \':!*CHANGES.rst\' \':!/*.tf\'   \':!/*.tfvars\'  \':!/*.hcl\' \':!/*Dockerfile\' \':!/*.yml\'  \':!/*celery.conf\'  \':!/*settings.py\'  ' sh > /tmp/$last.diff
